    ...
    <div className="p-8 max-w-6xl mx-auto space-y-8 animate-in zoom-in-95 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-1 space-y-6">
          ...
          <ToolRunner
            categoryLabel="Honeypots — Real Execution"
            color="purple"
            tools={[
              { id: 'cowrie', name: 'Cowrie', github: 'cowrie/cowrie' },
              { id: 'conpot', name: 'Conpot', github: 'HONEYPOT-Project/conpot' },
              { id: 'opencanary', name: 'OpenCanary', github: 'thinkst/opencanary' },
            ]}
          />
        </div>
